...
export const MuiButton = () => {
    ...
    return (
        <Stack spacing={4}>
            ...
            <Stack spacing={2} direction='row'>
                <Button variant='contained' startIcon={<SendIcon />} disableRipple onClick={() => alert('Clicked')}>No Ripple & Alert</Button>
                <Button variant='contained' endIcon={<SendIcon />} disableElevation>No Elevation</Button>
